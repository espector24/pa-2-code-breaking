...
**NAMES:** Alondra C and Edan S


```{r}
#| label: loading in tidyverse
...
```{r}
#| label: adding my_symbols
# finds total number of symbols 
...
```{r}
#| label: next steps
#we followed durections on the math we had to do
